            ...
            <div class="card-block">
                ...
                <form class="form-horizontal" method="post" action="{{ url('admin/user/update') }}">
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="name" id="display_name" class="form-control input-lg" placeholder="Full Name" tabindex="3"  required data-validation-required-message= "Please enter display name." value="{{ Auth::user()->name }} ">
