                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form" method="post" 
                              @if(isset($edit))
                              action="{{url('/admin-subcategory-update/'.$edit->id)}}"
                              @else
                              ...
                              <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="eventRegInput1" class="form-control border-primary" placeholder="SubCustomer Name" name="name" 
                                           @if(isset($edit))
                                           value="{{$edit->name}}" 
                                           @endif
                                           >
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->name; ?></td>
                                    <td>
                                        <a href="{{url('admin-subcategory/edit/'.$row->id)}}" title="Edit" class="btn btn-sm btn-outline-info"><i class="icon-pencil22"></i></a>
                                        <a  href="{{url('admin-subcategory/delete/'.$row->id)}}" title="Delete" class="btn btn-sm btn-outline-danger"><i class="icon-cross"></i></a>
