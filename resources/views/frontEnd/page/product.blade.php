                        ...
                        <div class="col-md-9">
                            ...
                            <div class="header-for-light">
                                <h1 class="wow fadeInRight animated" data-wow-duration="1s">
                                    @if(isset($subcatName)) {{ $subcatName->name }} @endif</h1>
                                    ...
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">
                                         <a href="{{url('/product/'.$p->id.'/'.$p->name)}}">
                                            <img style="max-height: 400px;" class="img-responsive" src="{{ URL::asset('upload/product/'.$p->photo) }}" alt="{{ $p->name }}" title="{{ $p->name }}">
                                        </a>
                                        </figure>
